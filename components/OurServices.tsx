      ...
      <div className="relative">
        ...
        <div className="flex absolute z-20 top-5 flex-row flex-wrap px-10 md:space-x-10 md:flex-nowrap xl:px-[5rem] 2xl:px-[10rem] md:px-[20rem] 3xl:px-[22rem] justify-around pt-10 w-full pb-4 lg:shadow-lg lg:rounded-lg">
          <div className="flex flex-col justify-center items-center w-[50%] md:w-full ">
            ...
            <p className="text-white text-xl w-full md:w-[65%] text-center pt-2">
              Riparia Area Restoration
            </p>
          </div>
          <div className="flex flex-col justify-center items-center w-[50%] md:w-full">
            <p
            ...
            <p className="text-white text-xl md:w-[95%] text-center pt-2">
              Erosion Control<span className="hidden md:inline">, Landslide Mitigation</span>
            </p>
          </div>
          <div className="flex flex-col justify-center items-center w-[50%] md:w-full">
            <p
            ...
            <p className="text-white text-xl md:w-[65%] text-center pt-2 ">
              Wetland Enhancement
            </p>
          </div>
          <div className="flex flex-col justify-center items-center w-[50%] md:w-full">
