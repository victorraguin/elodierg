...
export default function ContactUs() {
  return (
    <>
      <div
        id="contact-us"
        className="pb-10 flex items-top justify-center  md:-top-[5rem] sm:items-center sm:pt-0 ">
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
          <div className="mt-8 overflow-hidden bg-clip-padding backdrop-filter backdrop-blur-xl p-8  text-white border border-[#ffffff3f] bg-[#ffffff48] rounded-xl shadow-md duration-200 transition ease-in-out text-center">
            ...
            <p className=" font-normal text-lg sm:text-xl text-[#252F40]  mt-2">
              We approach every partnership and project with commitment and
              care. We invest in developing long-term dynamic relationships with
              our clients and community. Contact us today for more information
              about our work, to request a quote or submit an inquiry. It will
              be a pleasure to hear from you by phone, email or using the
              contact form below.
            </p>
              ...
              <form action="#" className="space-y-6">
                ...
                <div className="flex flex-row w-full flex-wrap md:flex-nowrap justify-around align-middle items-center ">
                  ...
                  <div className="flex flex-col items-center mt-4 text-[#252F40]">
                    ...
                    <a
                      href="tel:250-818-1661"
                      className="ml-4 pt-2 text-md tracking-wide font-semibold hover:underline cursor-pointer">
                      250-818-1661
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col items-center mt-2 text-[#252F40]">
                    ...
                    <a
                      href="mailto:Elodie@originsenvironmental.com"
                      className="ml-4 pt-2  hover:underline cursor-pointer text-md tracking-wide font-semibold ">
